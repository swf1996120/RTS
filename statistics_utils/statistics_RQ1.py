...
from statistics_utils.statistics_utils import get_exp_name, get_base_fig_dir, get_base_table_dir, get_order_arr, \
    get_RQ1_table_path, get_raw_result_dir, num_to_str
...
def statistics(csv_path, ratio):
    arr1 = ["DeepDAC", "DeepDiv", "Gini", "CES", "LSA", "MAX_P", "Random", "Kmeas_sample",
            "KCenterGreedy", "var_rank", "varw_rank", "ood_gini", "DeepDAC-var1", "DeepDAC-var2", "DeepDAC-var3",
            "msp_gini", "entrory_dropout_rank", "BALDDropout", "BADGE_sample", "CLUE_sample"]
...
def RQ1():
    for ratio in [0.025, 0.05, 0.075, 0.1]:
        csv_path = get_RQ1_table_path() + "{}.csv".format(ratio)
