...
def get_rank_func(x_train, y_train, rank_name_list, model_path, dataname, x_s, cov_initer, max_select_size, th=0.001,
    ...
    name_func_map = {
        ...
        "DeepDiv": functools.partial(ranker.div_rank, th=th, nb_classes=nb_classes),
        ...
        "DeepDAC": functools.partial(ranker.dac_rank, nb_classes=nb_classes, dataname=dataname, x_train=x_train,
                                     y_train=y_train),
        "DeepDAC_filter": functools.partial(ranker.dac_filter_rank,nb_classes=nb_classes, dataname=dataname, x_train=x_train,
                                  y_train=y_train),
        "DeepDAC_2": functools.partial(ranker.dac_2_rank,nb_classes=nb_classes, dataname=dataname, x_train=x_train,
                                  y_train=y_train, select_size=max_select_size),
        "DeepDAC-var1": functools.partial(ranker.dac_rank_va1, nb_classes=nb_classes, dataname=dataname, x_train=x_train,
                                     y_train=y_train),
        "DeepDAC-var2": functools.partial(ranker.dac_rank_va2, nb_classes=nb_classes, dataname=dataname, x_train=x_train,
                                          y_train=y_train),
        "DeepDAC-var3": functools.partial(ranker.dac_rank_va3, nb_classes=nb_classes, dataname=dataname, x_train=x_train,
                                          y_train=y_train),
    }
