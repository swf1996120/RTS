...
from gen_model.model_cifar100_vgg16 import model_cifar100_vgg16
from gen_model.model_cifar100_resNet20 import model_cifar100_resNet20
from gen_model.model_caltech_vgg16 import model_caltech_vgg16
from gen_model.model_caltech_resNet20 import model_caltech_resNet20
...
def gen_model_detail(fp, data_name, model_name, X_train, Y_train, X_test, Y_test, ):
    if not os.path.exists(fp):  # 如果没有模型
        ...
        elif model_name == model_conf.vgg16 and data_name == model_conf.cifar100:
            model_cifar100_vgg16(X_train, Y_train, X_test, Y_test, fp)
        elif model_name == model_conf.resNet20 and data_name == model_conf.cifar100:
            model_cifar100_resNet20(X_train, Y_train, X_test, Y_test, fp)
        elif model_name == model_conf.vgg16 and data_name == model_conf.caltech:
            model_caltech_vgg16(X_train, Y_train, X_test, Y_test, fp)
        elif model_name == model_conf.resNet20 and data_name == model_conf.caltech:
            model_caltech_resNet20(X_train, Y_train, X_test, Y_test, fp)
        else:
